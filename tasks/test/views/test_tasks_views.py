...
class TaskAPITestCase(APITestCase):
    ...
    def test_create_task(self):
        ...
        self.assertTrue(Task.objects.filter(title=data.get('title')).exists())
    ...
    def test_create_task_invalid_due_date(self):
        ...
        self.assertFalse(Task.objects.filter(title=data.get('title')).exists())
    ...
    def test_update_task(self):
        ...
        self.assertEqual(self.task.due_date.isoformat(), data['due_date'])
